...
artifacts: [decisions]
---
<!-- amibou:adapted from kit/.agents/skills/onboard/SKILL.md (MIT, (c) 2026 Nate Herk); the changes below are Amibou's -->

# Onboard, through Amibou

Nate Herk's `onboard` skill run from a project repository against the person's private brain. Read `<brain>/.agents/skills/onboard/SKILL.md` and follow it with these substitutions, which are Amibou's:
