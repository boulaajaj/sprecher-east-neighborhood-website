...
artifacts: [audits]
---
<!-- amibou:adapted from kit/.agents/skills/audit/SKILL.md (MIT, (c) 2026 Nate Herk); the changes below are Amibou's -->

# Audit, through Amibou

Nate Herk's `audit` skill run from a project repository against the person's private brain. Read `<brain>/.agents/skills/audit/SKILL.md`, its `rubric.md`, `history.md` and `compatibility.md`, and follow them with these substitutions, which are Amibou's:
